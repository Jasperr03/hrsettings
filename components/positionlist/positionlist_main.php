                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr id="trpositionupdate_input_<?php echo $position_row['positionId'] ?>" class="positioneditiput" hidden>
                                    <td></td>
                                    <td><input id="update_positionCode<?php echo $position_row['positionId'] ?>" class="form-control form-control-sm" type="text" value="<?php echo htmlspecialchars($position_row['positionCode']) ?>" required></td>
                                    <td><input id="update_position<?php echo $position_row['positionId'] ?>" class="editinputsg form-control form-control-sm" type="text" value="<?php echo htmlspecialchars($position_row['position']) ?>" required></td>
                                    <td>
...
<script>
    ...
    function updateposition(positionId) {
        ...
        // Add 'required' attribute to update fields
        $('#update_positionCode' + positionId).prop('required', true);
        $('#update_position' + positionId).prop('required', true);
        $('#update_salaryGrade' + positionId).prop('required', true);
        // Remove 'required' attribute from insert fields
        $('#insert_positionCode').prop('required', false);
        $('#insert_position').prop('required', false);
        $('#insert_salaryGrade').prop('required', false);
    }
    ...
    function loadupdate_position(positionId) {
        ...
        if (positionCode === '' || position === '' || salaryGrade === '') {
