...
<div class="modal-body">
    <form id="frmeditgroupsett">
        <div class="row g-3 align-items-center">
            ...
            <input id="editgroupname" value="<?php echo $schoolsett['groupsetting'] ?>" class="form-control form-control-sm mt-0" type="text" required>
            <label class="mt-2">Order No:</label>
            <input id="editgrouporder" value="<?php echo $schoolsett['orderNo'] ?>" class="form-control form-control-sm mt-0" type="number" required>
        </div>
    </form>
</div>
<div class="modal-footer py-2">
    <button type="button" class="btn btn-secondary btn-sm px-4 rounded" data-bs-dismiss="modal">Close</button>
    <button type="submit" form="frmaddgroupsett" class="btn btn-primary btn-sm px-4 rounded">Save Changes</button>
</div>
<script>
