                ...
                <div class="col-lg-4 col-md-6 col- p-3">
                    <div class="card shadow">
                        <div id="groupsettcard<?php echo $row['groupsettId']; ?>" class="groupSett card-header bg-primary text-white d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <i class="cursor-pointer fa-solid fa-box-archive mx-2" onclick="archive_grpsetting(<?php echo $row['groupsettId'] ?>)"></i>
                                <i class="cursor-pointer fa-solid fa-pen-to-square" onclick="load_editgroupset_modal(<?php echo $row['groupsettId'] ?>)"></i>
                            </div>
                        </div>
